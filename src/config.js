...
const ENEMY_TYPES = {
  ...
  // 六边形：六芒脉冲 - 大脉冲+6发小弹
  hexagon: { hp: 100, speed: 0.8, bulletSpeed: 1.5, radius: 22, score: 500, color: '#aa44ff', fireRate: 70, attackType: 'spiral' },
  // 追踪者：蓄力冲刺
...
const ROGUE_WAVES = [
  ...
  { enemies: [{type:'circle',count:10},{type:'chaser',count:12},{type:'triangle',count:8}], eliteChance: 0.2 },
